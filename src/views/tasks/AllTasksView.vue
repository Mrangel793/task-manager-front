        ...
        <div v-if="canCreateTask" class="border-t border-gray-100">
          ...
          <div v-else class="px-4 pt-4 pb-3 bg-white border-t-2 border-t-primary-500" @click.stop>
            ...
            <div class="flex items-center justify-between">
              ...
              <button type="button" @click="submitQuickCreate" :disabled="!quickCreateTitle.trim() || quickCreateSaving" class="text-lg font-bold px-6 py-2 rounded-xl transition-all" :class="quickCreateTitle.trim() && !quickCreateSaving ? 'bg-primary-600 text-white hover:bg-primary-700 shadow-md' : 'bg-gray-100 text-gray-400 cursor-not-allowed'">
