...
const baseItems = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      badge: count > 0 ? { count: count, color: 'bg-red-100 text-red-600' } : null
    },
    {
      name: 'profile',
      label: 'Mi Perfil',
...
// Elementos solo para Admin (computed para reactividad del badge)
  ...
  return [
    {
      ...
      badge: completedCount > 0 ? { count: completedCount, color: 'bg-green-100 text-green-600' } : null
    },
    {
      name: 'users',
      label: 'Usuarios',
